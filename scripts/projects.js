export const FEprojects = [
    {
        ...
        useEffect and hooks.`,
        instructions: `As soon as you open the project it will ask you to set you budget, add the amount of your preferences, add them in US currency for a better experience, later in the little lightblue icon in the bottom right with the "+" you will start adding your expenses.
        </br></br>
    ...
    },
    {
        ...
        instructions: `It's pretty simple to use this project, just select the currency and cryptocurrency you wold like to know the price of, submit it and then you will see the result down below`,
    ...
    },
    {
        ...
        instructions: `Search for the category of food you like in the input element, and see all the recipes 
    ...
    },
    {
        ...
        the API.`,
        instructions: `Search for the images you would like to see and see the result down below, if your 
        search has more than 30 images you will be able to the the rest of the result in the 
        pagination in the bottom of the page`,
    ...
    },
    {
        ...
        instructions: `Choose money range and term`,
    ...
    },
    {
        ...
        instructions: `First search for the countries available in the second 
    ...
    },
    {
        ...
        instructions: `So the algorithm works like this: the price base is $2000, every year that the vehicle 
...
export const FSprojects = [
    {
        boxClass: "uptask",
        thumb: "imagenes/Captura de pantalla 2023-11-22 122547.png",
        title: "UpTask - Projects Manager",
        text: `This project allows users to create an account with their email and start 
        creating different types of projects, create tasks for these projects, mark when 
        they have already been completed and, most importantly, add collaborators who can 
        help carry out the tasks of these Projects.</br></br>
        Frontend is hosted in cloudflare pages, backend in vercel and the database is in MongoDB.`,
        instructions: `As soon as you have created your account you can 
        start creating projects from the sidebar, you can edit the information
        of this project and also add tasks to it, complete them, edit them or 
        delete them. </br></br>
        In the blue button that appears below you can enter emails 
        from other users who you want to collaborate with this project.`,
        link: "https://uptask-frontend.pages.dev/",
        git: "https://github.com/danielurz/uptask-repo"
    },
    {
        boxClass: "apv",
        thumb: "imagenes/Captura de pantalla 2023-11-22 122907.png",
        title: "Patient Manager of Veterinary",
        text: `This project is developed for veterinarians, veterinarians can create 
        an account with their data and store their patients, edit and delete them whenever 
        they want, they can also add more personal information and also edit it.</br></br>
        Frontend is hosted in cloudflare pages, backend in vercel and the database is in MongoDB.`,
        instructions: `You can create patients from the form as soon as you log in, 
        add and delete them in the corresponding icons by hovering over the patients 
        and also edit the veterinarian's information in the "profile" link.`,
        link: "https://apv-frontend.pages.dev/",
        git: "https://github.com/danielurz/apv-repo"
    },
    {
        boxClass: "propitch",
        thumb: "imagenes/Captura de pantalla 2023-11-22 221922.png",
        title: "Propitch",
        text: `This project was developed with the purpose of managing the administration 
        payment of the owners corresponding to the residential complex where they belong. 
        </br></br>
        Also to create interactivity through the web between the owners and administrative staff.`,
        instructions: ``,
        link: "",
        git: "https://github.com/danielurz/propitch-repo"
    },
]